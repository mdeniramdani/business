            ...
            <nav class="navbar navbar-default">
              ...
              <div class="collapse navbar-collapse main-menu bs-example-navbar-collapse-1" id="navbar-example">
                <ul class="nav navbar-nav navbar-right">
                  <li class="active">
                    <a class="page-scroll" href="<?php echo base_url('index.html')?>">Home</a>
                  </li>
                  <li>
          ...
          <div class="slider-content text-center">
            <div class="header-bottom">
              <div class="layer2 wow zoomIn" data-wow-duration="1s" data-wow-delay=".4s">
                <h1 class="title2">BUSINESS</h1>
              </div>
              <div class="layer3 wow zoomInUp" data-wow-duration="2s" data-wow-delay="1s">
                <h2 class="title3">We're The Business Of Helping You Start Your Business</h2>
              </div>
            </div>
          </div>
        </div>
          ...
          <div class="row">
            <div class="col-md-12 col-sm-12 col-xs-12 col-sm-offset-3">
              ...
              <ul class="project-menu">
                <li>
                  <a href="#" class="active" data-filter="*">BERITA</a>
                </li>
                <li>
                  <a href="#" data-filter=".kota">KOTA</a>
                </li>
                <li>
                  <a href="#" data-filter=".olahraga">OLAHRAGA</a>
                </li>
              </ul>
            </div>
              </article>
                      ...
                      <li class="threaded-comments">
                        <div class="comments-details">
                          <div class="comments-list-img">
                            <img src="<?php echo base_url('img/blog/b02.jpg')?>" alt="post-author">
                          </div>
...
<!-- Start Footer bottom Area -->
  ...
  <script src="<?php echo base_url('https://maps.googleapis.com/maps/api/js?key=AIzaSyD8HeI8o-c1NppZA-92oYlXakhDPYR7XMY')?>"></script>
